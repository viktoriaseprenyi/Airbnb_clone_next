        ...
        <form action={CreateDescription}>
            ...
            <div className="mx-auto w-3/5 mt-10 flex flex-col gap-y-5 mb-36">
                ...
                <div className="flex flex-col gap-y-2">
                    ...
                    <Textarea name="description" required placeholder="Please write something about your home..."/>
                </div>
                <div className="flex flex-col gap-y-2">
                    <Label>Price</Label>
                    <Input name="price" type="number" required placeholder="Price per night in USD" min={10}></Input>
                </div>
                <div className="flex flex-col gap-y-2">
                    <Label>Image</Label>
